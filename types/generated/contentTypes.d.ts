...
export interface ApiCoacheCoache extends Schema.CollectionType {
  ...
  attributes: {
    ...
    dan: Attribute.String & Attribute.Required;
    ...
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::coache.coache', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::coache.coache', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiGalleryGallery extends Schema.SingleType {
  ...
  attributes: {
    sources: Attribute.Media & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::gallery.gallery', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::gallery.gallery', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiPagePage extends Schema.CollectionType {
  ...
  attributes: {
    navigation: Attribute.Relation<'api::page.page', 'oneToOne', 'api::navigation.navigation'>;
    title: Attribute.String & Attribute.Required;
    preview: Attribute.Media & Attribute.Required;
    additional: Attribute.DynamicZone<
      ['home-page.contacts', 'home-page.coaches', 'home-page.partners']
    >;
    content: Attribute.RichText &
      Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
